...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="font-family: Noto Serif Lao">ແກ້ໄຂຂໍ້ມູນລູກຄ້າ</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<select name="sex" class="form-control">
							<option value="0" <?php if($old['sex']== 0) echo('selected = "selected"'); ?>>ຊາຍ</option>
							<option value="1"<?php if($old['sex']== 1) echo('selected = "selected"'); ?>>ຍິງ</option>
						</select><br/>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
					<label class="col-sm-3 control-label">ໝາຍເຫດ</label><br/><br/>
